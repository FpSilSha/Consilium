...
export function SharedInputBar(): ReactNode {
  ...
  const handleSubmit = useCallback(() => {
    ...
    // Check if this is an @mention directive for agent-to-agent interaction
    ...
    <div className="flex flex-col gap-2">
      {showRepeat && hasLastExchange() && (
        <button
          ...
          className="self-start rounded border border-gray-700 px-2 py-1 text-xs text-gray-400 hover:border-gray-500 hover:text-gray-200"
        >
