    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 text-xs leading-relaxed text-yellow-200">
          ...
          of those are available on this system. You can still <strong className="text-yellow-100">enter and use
          API keys for this session</strong> — they'll work normally — but they{' '}
          <strong className="text-yellow-100">will not be saved to disk</strong> and you'll
          need to re-enter them every time you start the app. Linux users: install{' '}
          ...
          (or your distro's equivalent) and relaunch to enable persistent storage.
        </div>
        <button
